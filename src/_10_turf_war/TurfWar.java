...
public class TurfWar extends PApplet {
    ...
    class Player {
        ...
        void drawPlayer() {
             ...
             */
        	rect(x,y,playerSize,playerColor);
    ...
    public void setup() {
       ...
       background(0,255,0);
         ...
         */
        player1 = new Player(10,10,10,10,Color.BLUE.getRGB(),UP,LEFT,DOWN,RIGHT);
        player2 = new Player(250,250,10,10,Color.RED.getRGB(),87,65,83,68);
   ...
   public void displayStats() {
    ...
    // additional for controls try using https://keycode.info/
